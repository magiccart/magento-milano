...
class Magiccart_Blog_Block_Last extends Magiccart_Blog_Block_Menu_Sidebar implements Mage_Widget_Block_Interface
{
    protected function _toHtml()
    {
        $this->setTemplate('magiccart/blog/widget_post.phtml');
